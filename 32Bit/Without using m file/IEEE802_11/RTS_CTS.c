...
double calculate_RTS_duration(NETSIM_ID d,
							  NETSIM_ID i,
							  NetSim_PACKET* packet)
{
	PIEEE802_11_PHY_VAR phy = IEEE802_11_PHY(d, i);
	fn_NetSim_IEEE802_11_SetDataRate(d, i, packet->nReceiverId, packet, pstruEventDetails->dEventTime);
...
static bool decide_RTS_CTS_Mechanism()
{
	...
	if (!p->nDestinationId)
		return false; //Broadcast application
